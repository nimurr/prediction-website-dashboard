          ...
          >
            ...
            <Form.Item>
              <button
                ...
                border
                type="submit"
                className="w-full flex items-center justify-center gap-3 bg-[#84df91] text-xl font-semibold text-white rounded-md py-2"
              >
                Send Verification Code {isLoading && <div role="status">
                  <svg aria-hidden="true" class="inline w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-[#84df91]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
