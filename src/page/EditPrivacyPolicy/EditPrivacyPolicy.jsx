...
import { useGetPrivacyPolicyQuery, useUpdatePrivacyPolicyAllMutation } from "../../redux/features/setting/settingApi"; // ✅ FIXED
...
const EditPrivacyPolicy = () => {
  ...
  const mainData = privacyPolicy?.data?.content;
  useEffect(() => {
    refetch();
    setContent(mainData);
  }, ["content"]);
      ...
      <div className="w-full p-6 rounded-lg shadow-md">
        <Form form={form} layout="vertical" onFinish={handleSubmit}>
          ...
          <div className="w-full flex justify-end mt-20 md:mt-16">
            <button
              type="submit"
              className="bg-[#4C1D95] text-white text-xl gap-2 py-2 px-8 rounded-md font-bold"
              disabled={isLoading}
            >
