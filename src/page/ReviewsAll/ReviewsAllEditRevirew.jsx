...
const ReviewsAllEditReview = () => {
            ...
            try {
                ...
                setFormData({
                    ...
                    lastUpdateDate: res.data.lastUpdateDate
                        ? res.data.lastUpdateDate.split("T")[0]
                        : "",
                });
            } catch (err) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate("/reviews"); // redirect after update
        } catch (error) {
        ...
        <div>
            ...
            <div className="max-w-3xl mx-auto p-6 my-10 bg-gray-100 shadow-lg rounded-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-[#704AAA] text-white py-2 rounded hover:bg-[#523480] transition-colors"
                    >
                        Update Review
                    </button>
                </form>
...
export default ReviewsAllEditReview;