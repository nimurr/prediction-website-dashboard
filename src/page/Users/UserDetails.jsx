...
const UserDetails = () => {
  ...
  const userDataFull = userData?.data?.attributes;
  console.log(userDataFull?.isBlocked);
      ...
      <div className="my-10 w-full md:w-2/4 mx-auto">
        ...
        <div className="flex items-center justify-between gap-5 mb-5">
          <div className="flex items-center gap-5">
            <img
              ...
              src={userDataFull?.profileImage ? imageBaseUrl + userDataFull?.profileImage : "https://cdn-icons-png.flaticon.com/512/149/149071.png"}
              alt="User"
            />
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              {
                userDataFull?.isBlocked ?
                  <button onClick={handleUserRemove} className="bg-[#3c80e7] text-white px-5 py-2 rounded-lg">UnBlock</button>
                  :
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between py-3 border-b-2 border-[#00000042]">
            ...
            <span>{userDataFull?.phoneNumber || "N/A"}</span>
          </div>
          <div className="flex items-center justify-between py-3 border-b-2 border-[#00000042]">
